...
export default function Homework() {
  ...
  const [form, setForm] = useState({ class_id: user?.role === 'teacher' && user?.class_id ? String(user.class_id) : '', subject_id: '', title: '', description: '', due_date: '' });
          ...
          <div className="card">
            ...
            <form onSubmit={handleCreate}>
              <div className="form-row">
                <div>
                  <label>Class</label>
                  <input value={form.class_id} onChange={e => setForm({ ...form, class_id: e.target.value })} required placeholder="Class ID" disabled={user?.role === 'teacher'} />
                </div>
                <div>
                  <label>Subject</label>
